<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-ink">Novo aprendiz</h2>
    </x-slot>

    <div class="py-10">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('aprendizes.store') }}" enctype="multipart/form-data"
                ...
                <div class="mt-6 flex items-center gap-3 border-t border-line pt-6">
                    ...
                    <a href="{{ route('aprendizes.index') }}" class="text-sm font-medium text-ink-muted hover:text-ink">
                        Cancelar
                    </a>
                </div>
            </form>
